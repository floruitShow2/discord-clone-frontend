...
function NaviSidebar() {
    ...
    return <div className="w-full h-full p-4 pr-6 flex items-center bg-primary justify-between shadow-sm">
        {/* Logo */}
        <div className="flex items-center justify-start">
            <img className="h-10" src={Logo} alt="" />
            <h4 className="font-bold text-primary-label">Meleon Discord Clone</h4>
        </div>
        {/* Operation btns */}
        <div className='flex items-center justify-end gap-2'>
            ...
            />
            <Tooltip content={theme === 'dark' ? $t['settings.theme.toLight'] : $t['settings.theme.toDark']}>
                <Button
                    type='secondary'
                    shape='round'
                    status='default'
